...
VOBA_VALUE_INLINE voba_value_t voba_make_symbol_data(const char * data, uint32_t len, voba_value_t symbol_table)
{
    voba_str_t tmp;
    tmp.data = (char*)data;
    tmp.capacity = 0;
...
VOBA_VALUE_INLINE voba_value_t voba__make_symbol_lowlevel(voba_value_t symbol_name, voba_value_t symbol_value)
{
...
VOBA_VALUE_INLINE voba_value_t voba_make_symbol_cstr(const char * symbol_name, voba_value_t symbol_table)
{
    return voba_make_symbol_data(symbol_name,(uint32_t)strlen(symbol_name), symbol_table);
}
VOBA_VALUE_INLINE voba_value_t voba_make_symbol_cstr_with_value(const char * symbol_name, voba_value_t symbol_table, voba_value_t v)
{
